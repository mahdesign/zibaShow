    ...
    Object.values(cartItems).map((item) => {
      productContainer.innerHTML += `
        ...
        <div class="row   my-2 khat">
            ...
            <div class="col-md-2  text-center my-auto">
                  <i class="fas fa-plus p-2 m-1 increase"></i><input type="text" value="${
                    item.inCart
                  }" id="numOfProduct" class="numOfProduct"><i class="fas fa-minus p-2 m-1 decrease"></i>
            </div>
            <div class="col-md-2   text-center my-auto">
...
function manageQuantity() {
  ...
  for (let i = 0; i < decreaseButton.length; i++) {
    decreaseButton[i].addEventListener("click", () => {
      ...
      currentproduct = srcImg.substr(IndexOfImg).replace(".jpg", "");
